...
public class GodClass extends ViewPart {
	...
	class ViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		...
		public Image getColumnImage(Object obj, int index) {
			Image image = null;
			if(obj instanceof ExtractClassCandidateGroup && index == 5){
				ArrayList<ExtractClassCandidateRefactoring> candidates = ((ExtractClassCandidateGroup)obj).getCandidates();
				...
				} else if (candidatesSelected < candidateCount){
					image = Activator.getImageDescriptor("/icons/" + "indeterminate.png").createImage();
				} else {
	...
	public void createPartControl(Composite parent) {
		...
		new TreeColumn(treeViewer.getTree(), SWT.LEFT).setText("Implement?");
		...
		treeViewer.getTree().addMouseListener(new MouseListener() {
			...
			public void mouseDown(MouseEvent e) {
				...
				if(element instanceof ExtractClassCandidateGroup){
